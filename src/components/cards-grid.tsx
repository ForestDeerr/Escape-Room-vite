  ...
  return (
    <div className="cards-grid">
      ...
      <div className="quest-card">
        <div className="quest-card__img">
          <picture>
            <source type="image/webp" srcSet="img/content/experiment/experiment-size-s.webp, img/content/experiment/experiment-size-s@2x.webp 2x" />
            <img src="img/content/experiment/experiment-size-s.jpg" srcSet="img/content/experiment/experiment-size-s@2x.jpg 2x" width="344" height="232" alt="Производственный цех." />
          </picture>
        </div>
        <div className="quest-card__content">
          <div className="quest-card__info-wrapper"><a className="quest-card__link" href="quest.html">Фатальный эксперимент</a>
          </div>
          <ul className="tags quest-card__tags">
            <li className="tags__item">
              <svg width="11" height="14" aria-hidden="true">
      ...
      <div className="quest-card">
        <div className="quest-card__img">
          <picture>
            <source type="image/webp" srcSet="img/content/metro/metro-size-s.webp, img/content/metro/metro-size-s@2x.webp 2x" />
            <img src="img/content/metro/metro-size-s.jpg" srcSet="img/content/metro/metro-size-s@2x.jpg 2x" width="344" height="232" alt="Мужчина на фоне кирпичной стены." />
          </picture>
        </div>
        <div className="quest-card__content">
          <div className="quest-card__info-wrapper"><a className="quest-card__link" href="quest.html">Метро 2033</a>
          </div>
          <ul className="tags quest-card__tags">
            <li className="tags__item">
              <svg width="11" height="14" aria-hidden="true">
      ...
      <div className="quest-card">
        <div className="quest-card__img">
          <picture>
            <source type="image/webp" srcSet="img/content/loft/loft-size-s.webp, img/content/loft/loft-size-s@2x.webp 2x" />
            <img src="img/content/loft/loft-size-s.jpg" srcSet="img/content/loft/loft-size-s@2x.jpg 2x" width="344" height="232" alt="Фотоапарат, очки и канцелярские предметы на фоне карты." />

          </picture>
        </div>
        <div className="quest-card__content">
          <div className="quest-card__info-wrapper"><a className="quest-card__link" href="quest.html">Старый чердак</a>
          </div>
          <ul className="tags quest-card__tags">
            <li className="tags__item">
              <svg width="11" height="14" aria-hidden="true">
      ...
      <div className="quest-card">
        ...
        <div className="quest-card__content">
          <div className="quest-card__info-wrapper"><a className="quest-card__link" href="quest.html">Последний рубеж</a>
          </div>
          <ul className="tags quest-card__tags">
            <li className="tags__item">
              <svg width="11" height="14" aria-hidden="true">
